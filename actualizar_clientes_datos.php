...
$result1 = mysql_query("SELECT * FROM clientes WHERE ID  LIKE '$codigo'");
$result2 = mysql_query("SELECT * FROM clientes WHERE ID  LIKE '$codigo'");
$result3 = mysql_query("SELECT * FROM clientes WHERE ID  LIKE '$codigo'");
$result4 = mysql_query("SELECT * FROM clientes WHERE ID  LIKE '$codigo'");
$result5 = mysql_query("SELECT * FROM clientes WHERE ID  LIKE '$codigo'");
$result6 = mysql_query("SELECT * FROM clientes WHERE ID  LIKE '$codigo'");
$result7 = mysql_query("SELECT * FROM clientes WHERE ID  LIKE '$codigo'");
$result8 = mysql_query("SELECT * FROM clientes WHERE ID  LIKE '$codigo'");
$result9 = mysql_query("SELECT * FROM clientes WHERE ID  LIKE '$codigo'");
$result10 = mysql_query("SELECT * FROM clientes WHERE ID  LIKE '$codigo'");
...
<table width="20" border="0" align="center" cellspacing="0">
  ...
  <tr>
    <td height="385"><form name="form1" method="post" action="actualizar_clientes.php?&amp;buscar=<?
...
?>" type="text">
            ...
            <tr bgcolor="#FFFFCC">
              <td height="7" bgcolor="#EEF3F7"><div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Tipo de Cliente  :</font></div></td>
              <td height="7" colspan="3" bgcolor="#EEF3F7"><select name="cliente" id="cliente">
            ...
            <tr bgcolor="#FFFFCC">
              ...
              <td height="40" colspan="3" bgcolor="#EEF3F7"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
                <input name="vehiculo" class="formulario" id="vehiculo" value="<?
