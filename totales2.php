...
<table width="566" border="0" align="center">
  <tr>
    <th width="479" bgcolor="#E3E9F1" scope="col"><div align="right" class="small">Total a Cancelar </div></th>
...
$feha=date("d-m-Y");
$test11a = mysql_query("SELECT SUM(subt) from consumo WHERE ref LIKE '$codigo3' ");
...
mysql_select_db($database ); 
$feha=date("d-m-Y");
$test11a = mysql_query("SELECT SUM(precio) from habitacion2 WHERE  id LIKE '$codigo3' ");
$test1 = mysql_fetch_row($test11a);
 $test1[0];
?>
      <?php $factura= $row_Recordset2['cant_dia'] * $test1[0]; ?>
      <?php echo  $test1c[0] + $factura ?> </th>
  </tr>
</table>
</body>
</html>
