...
<table width="874" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"><table width="770" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="141" height="25" valign="top" bgcolor="#FFFFFF"><?php include("menu2.php");?>
          <br /></td>
...
$sSQL="Update usuarios2  Set  
  opc='$opc'
  
Where email like'$codigo2'";
...
?>
                ...
                <p align="center" class="Estilo1">Se ha confirmado su registro como usuario correctamente </p></td>
