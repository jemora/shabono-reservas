...
<tr>
  <td class="estilocelda">Datos de Habitaci&ograve;n</td>
</tr>
<tr><td><table width="601" height="15" border="0" align="center" cellspacing="0" bordercolor="#000000" bgcolor="#FF9900">
  <tr>
    <td width="591" height="28" bgcolor="#FFFFFF"><table width="601" border="0" align="center" cellspacing="0" bgcolor="#F4F4F4">
      <!--DWLayoutTable-->
      <tr>
        <td width="587" height="149" valign="top"><table width="599" border="0" align="center" cellspacing="0">
            <!--DWLayoutTable-->
            <tr>
...
?>
            ...
            <tr>
              <td bgcolor="#E3E9F1"><div align="left" ><strong>Servicio:</span></strong></div></td>
...
?>
            ...
            <tr>
              ...
              <td width="104" bgcolor="#FFFFFF"><span >
                <?
	 //Mostramos los registros<br>
...
?>
            ...
            <tr>
              <td bgcolor="#E3E9F1"><div align="left" ><strong>Cantidad de Personas</span>:</strong></div></td>
...
?>
            ...
            <tr>
              <td bgcolor="#E3E9F1"><strong>Monto en Nota creditos:</span></strong></td>
...
?>
            ...
            <tr>
              <td bgcolor="#E3E9F1"><strong>Observaciones:</span></strong></td>
              <td colspan="3" bgcolor="#FFFFFF">
                <?
	 //Mostramos los registros<br>
...
?>
            ...
            <tr>
              <td colspan="3" bgcolor="#F4F4F4"><!--DWLayoutEmptyCell-->&nbsp;</td>
              <td bgcolor="#F4F4F4"><font face="Arial" size="1"><a href="?&amp;id=borrar&amp;codigo=<? while ($row=mysql_fetch_array($result9))
      { echo "".$row["id"].""; } mysql_free_result($result9)
?>&usuario=<?  echo  $usuario; ?>&pass2=<?  echo  $pass2; ?>"><img src="imagenes/anular.gif" alt="Borrar " width="153" height="31" border="0" onClick="GP_popupConfirmMsg('&iquest;Est&aacute;s seguro que quieres Anular este registro?');return document.MM_returnValue" /></a></font></td>
            </tr>
        </table></td>
      </tr>
    </table>
